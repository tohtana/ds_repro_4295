...
torch.cuda.set_device(script_args.local_rank)
...
training_arguments = TrainingArguments(
    ...
    deepspeed=script_args.deepspeed_config if script_args.deepspeed else None,
    # resume_from_checkpoint=script_args.model_path,
)
